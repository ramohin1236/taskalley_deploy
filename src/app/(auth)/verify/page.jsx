                  ...
                  <div className="p-6 sm:p-8 ">
                    ...
                    <form className="mt-12 space-y-6">
                      ...
                      <div className="flex flex-col gap-2">
                        <label className="bg-white text-slate-500 font-semibold text-base rounded h-52 flex flex-col items-center justify-center cursor-pointer border-2 border-gray-300 border-dashed mx-auto w-full">
                          <svg
